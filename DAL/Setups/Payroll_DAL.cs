...
{
    public class Payroll_DAL:DBInteraction
    {
        ...
        public Payroll_DAL(Payroll_Property payroll)
        {
        ...
        public DataTable GetEmployeeForPayroll()
        {
            ...
            cmdToExecute.CommandText = "dbo.[sp_Attendance_Employee_SelectALL]";
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Employee_Attendance_SAlary_ByDate]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Attendance_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@from", SqlDbType.Date, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, objpayrollproperty.fromDate));
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@attid", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, objpayrollproperty.attendance_id));
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[sp_Get_All_Payrolls]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("Attendance_SETUP");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
